 ...
 *
 * SCCS: @(#) tkInt.h 1.179 96/12/16 14:01:01
 */
...
typedef struct TkClassProcs {
    TkClassCreateProc *createProc; /* Called by Tk_MakeWindowExist. */
...
EXTERN void		TkpCloseDisplay _ANSI_ARGS_((Display *displayPtr));
...
EXTERN Window		TkpMakeWindow _ANSI_ARGS_((TkWindow *winPtr,
			    Window parent));
EXTERN Display *	TkpOpenDisplay _ANSI_ARGS_((char *display_name));
